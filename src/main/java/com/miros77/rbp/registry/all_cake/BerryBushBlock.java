...
public class BerryBushBlock extends SweetBerryBushBlock {
  ...
  public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
    return new ItemStack(ModItems.STRAWBERRYBUSH);
  }
  ...
  public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand,
    ...
    if (!bl && player.getStackInHand(hand).getItem() == Items.BONE_MEAL) {
      ...
      dropStack(world, pos, new ItemStack(ModItems.STRAWBERRYBUSH, j + (bl ? 1 : 0)));
  ...
  public void onStacksDropped(BlockState state, World world, BlockPos pos, ItemStack stack) {
    ItemStack bush = new ItemStack(ModItems.STRAWBERRYBUSH);
